<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html>
	...
	<style>
		...
		<link href="/Jmt/tpl/simplebootx/Public/css/slippry/slippry.css" rel="stylesheet">
		<style>
...
<div class="navbar navbar-fixed-top">
   <div class="navbar-inner">
     <div class="container">
       ...
       <a class="brand" href="/Jmt/"><img src="/Jmt/tpl/simplebootx/Public/images/logo.png"/></a>
				...
				<div class="header">
					<div class="item-image">
						<a href="<?php echo leuu('article/index',array('id'=>$vo['tid']));?>">
							<?php if(empty($smeta['thumb'])): ?><img src="/Jmt/tpl/simplebootx/Public/images/default_tupian1.png" class="img-responsive" alt="<?php echo ($vo["post_title"]); ?>"/>
							<?php else: ?> 
...
<script src="/Jmt/tpl/simplebootx/Public/js/slippry.min.js"></script>
<script>
$(function() {
