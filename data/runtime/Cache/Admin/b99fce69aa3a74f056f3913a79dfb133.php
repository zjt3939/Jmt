...
<![endif]-->
<link rel="stylesheet" href="/Jmt/statics/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?">
<!--[if lte IE 8]>
	<link rel="stylesheet" href="/Jmt/statics/simpleboot/css/simplebootadminindex-ie.css?" />
<![endif]-->
<style>
...
<body style="min-width:900px;" screen_capture_injected="true">
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				<a href="/Jmt/index.php?g=admin&m=index&a=index" class="brand"> <small> 
				<img src="/Jmt/statics/images/icon/logo-18.png">
						ThinkCMF 后台
				</small>
				</a>
				<div class="pull-left nav_shortcuts" >
					
					<a class="btn btn-small btn-warning" href="/Jmt/" title="前台首页" target="_blank">
				...
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<img class="nav-user-photo" src="/Jmt/statics/images/icon/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>">
	...
	<script src="/Jmt/tpl_admin/simpleboot/assets/js/index.js"></script>
